            ...
            <div class="clearfix mb-3">
                <div class="float-right">
                    ...
                    <div class="dropdown-menu" style="">
                        <a class="dropdown-item" tabindex="-1" href="{{ route('user.tasks.create',['taskTypeId' => 3]) }}">To do</a>
                        <a class="dropdown-item" tabindex="-1" href="{{ route('user.tasks.create',['taskTypeId' => 1]) }}">Resident request</a>
                        <a class="dropdown-item" tabindex="-1" href="{{ route('user.tasks.create',['taskTypeId' => 2]) }}">Rental owner request</a>
                        <a class="dropdown-item" tabindex="-1" href="{{ route('user.tasks.create',['taskTypeId' => 4]) }}">Contact request</a>
                    </div>

                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                        Add recurring Tasks
                    </a>
                    <div class="dropdown-menu" style="">
                        <a class="dropdown-item" tabindex="-1" href="#">To do</a>
                        <a class="dropdown-item" tabindex="-1" href="#">Resident request</a>
                        <a class="dropdown-item" tabindex="-1" href="#">Rental owner request</a>
                    </div>

                    <a class="btn btn-default" href="{{ route('user.task_categories.index') }}"> Task Categories </a>
                </div>
            </div>
